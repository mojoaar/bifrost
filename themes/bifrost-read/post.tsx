  ...
  return (
    <article className="mx-auto max-w-3xl">
      <header className="mb-8 border-b border-border pb-6">
        ...
        <div className="mt-3 flex flex-wrap items-center gap-3 text-sm text-text-3">
              ...
              <div className="flex flex-wrap gap-1.5">
                {tags.map((t) => (
                  <a
                    key={t}
                    href={`/tag/${t}`}
                    className="rounded border border-border bg-bg-1 px-1.5 py-0.5 text-text-3 transition hover:border-accent hover:text-accent"
                  >
                    #{t}
                  </a>
                ))}
