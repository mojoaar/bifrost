...
export function useCodeCopyButtons(html: string) {
  ...
  useEffect(() => {
    ...
    preBlocks.forEach((pre) => {
      ...
      btn.className =
        "absolute top-2 right-2 z-10 rounded-md border border-border bg-bg-1 p-1.5 text-text-2 opacity-0 transition hover:border-accent hover:text-accent group-hover/code:opacity-100";
